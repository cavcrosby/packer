...
- `content` (string) - This content will be written and executed as-is.
  It will be saved to a file and run without modifications. Please ensure
  that all necessary dependencies on the target system are already installed
